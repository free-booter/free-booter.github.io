      ...
      "/guide": [
        {
          items: [
            ...
            },
            {
              text: "TypeScript",
              collapsed: true,
              items: [{ text: "keyof", link: "/guide/typescript/keyof" }],
            },
            {
              text: "工程化",
              collapsed: true,
            ...
            { text: "网络", link: "/guide/network" },
            {
              text: "工具方法",
              collapsed: true,
              items: [{ text: "常用方法", link: "/guide/utils/" }],
            },
            {
              text: "数据结构与算法",
              collapsed: true,
              items: [
                ...
                { text: "队列", link: "/guide/algorithm/queue" },
                {
                  ...
                  items: [
                    {
                      text: "基础理论",
                      link: "/guide/algorithm/binaryTree/theory",
                    },
                  ],
                },
              ],
      ...
      "/share/": [
        {
          items: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    {
                      text: "proxy",
                      link: "/share/vue/reactivity/proxy",
                    },
                    {
                      text: "ref",
                      link: "/share/vue/reactivity/ref",
                    },
                    {
                      text: "reactive",
                      link: "/share/vue/reactivity/reactive",
                    },
                  ],
                },
            ...
            },
            {
              text: "React源码分析",
              collapsed: false,
              items: [{ text: "网页生成截图", link: "/share/react/" }],
            },
          ],
        },
      ],
          ...
          items: [
            {
              ...
              items: [
                {
                  text: "真机测试时，无法显示覆盖在canvas上的图片或其他内容",
                  link: "/resolve/applet/coverImage",
                },
              ],
            },
            {
